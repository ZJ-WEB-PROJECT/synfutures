  ...
  <section class="section">
    ...
    <div class="marquee">
      <div class="partner-marquee track">
        <img v-for="item in doubled" :key="item.name + item.i" :src="item.logo" :alt="item.name" />
      </div>
    </div>
    <div class="wrap">
      <div class="summit">
        ...
        <a class="btn btn-brand" href="https://Cervanta.cam/" target="_blank" rel="noreferrer">View More</a>
      </div>
    </div>
  </section>
</template>
...
.pill {
  border: 1px solid rgba(241, 244, 52, 0.3);
  background: rgba(241, 244, 52, 0.1);
